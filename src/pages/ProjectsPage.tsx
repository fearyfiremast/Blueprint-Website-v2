  ...
  return (
    <PageContainer className="bg-bp-lightest-grey relative z-0">
      <div className="w-full h-0 xl:ml-[-144px] max-[1279.9px]:ml-[-40px]">
        <div className="bg-[url('/images/crosspoint.png')] bg-no-repeat z-[100]
                    min-[1600px]:bg-[calc(50%+270px)_-390px]
                    max-[1599.9px]:bg-[calc(100%+610px)_-390px]
                    max-[1279.9px]:bg-[calc(100%+715px)_-390px]
                    max-[1023.9px]:bg-[calc(100%+715px)_-390px]
                    max-[767.9px]:bg-[calc(100%)_-500px] max-[767.9px]:w-[calc(100%+17px)]
        ...
        <video
            ...
            className="
                      ...
                      min-[768px]:w-[500px]
                      max-[767.9px]:right-[-150px] max-[767.9px]:top-[-20px] max-[767.9px]:w-[250px]
                      absolute  z-[-1]">
